          ...
          <div className="flex-1 max-w-6xl">
           ...
           <div className="mt-2 text-[12px] text-slate-500 flex items-center gap-3">
            ...
            <div className="mt-3 flex items-center gap-1.5 flex-wrap text-[12px] text-slate-400">
              <a href="/" className="hover:text-[#0B3BFF] transition-colors no-underline font-semibold">Home</a>
              <span className="text-slate-300 text-[10px]">{">>"}</span>
              <a href="/blogs" className="hover:text-[#0B3BFF] transition-colors text-[#0037CA] no-underline font-semibold">Blog</a>
              <span className="text-slate-300 text-[10px]">{">>"}</span>
