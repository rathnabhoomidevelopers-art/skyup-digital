      ...
      >
        <div className="mx-auto max-w-5xl text-[#111827]">
          ...
          <p className="mt-3 text-[14px] sm:text-[16px] leading-relaxed text-[#374151]">
            This Privacy Policy outlines how SKYUP Digital Solutions ("we",
            "our", "us") collects, uses, discloses, and protects personal
            information obtained from users ("you", "your") who visit our
            website or engage with our digital marketing services. We are
          ...
          <ul className="mt-3 list-disc pl-5 space-y-2 text-[14px] sm:text-[16px] text-[#374151]">
            ...
            <li>Job title</li>
            <li>
              Any information submitted through contact forms, lead forms, or
              inquiries
            </li>
          </ul>
          ...
          <ul className="mt-3 list-disc pl-5 space-y-2 text-[14px] sm:text-[16px] text-[#374151]">
            <li>
              Lead data collected via platforms such as Google Ads, Meta
              (Facebook/Instagram), LinkedIn Ads, or other advertising channels
            </li>
            <li>
              Campaign interaction data, including form submissions and
              engagement metrics
            </li>
          </ul>
          ...
          <ul className="mt-3 list-disc pl-5 space-y-2 text-[14px] sm:text-[16px] text-[#374151]">
            ...
            <li>
              To deliver digital marketing, advertising, and consulting services
            </li>
            <li>
              To improve website performance, user experience, and service
              quality
            </li>
            <li>To manage leads, campaigns, and client communication</li>
            <li>
              To send service-related updates, proposals, or marketing
              communications (only where permitted)
            </li>
          ...
          <p className="mt-3 text-[14px] sm:text-[16px] leading-relaxed text-[#374151]">
            Our website may use cookies, pixels, and similar tracking
            technologies to:
          </p>
          <ul className="mt-3 list-disc pl-5 space-y-2 text-[14px] sm:text-[16px] text-[#374151]">
          ...
          <p className="mt-3 text-[14px] sm:text-[16px] leading-relaxed text-[#374151]">
            ...
            Disabling cookies may affect certain website functionalities.
          </p>
          ...
          <ul className="mt-3 list-disc pl-5 space-y-2 text-[14px] sm:text-[16px] text-[#374151]">
            <li>
              With trusted service providers and partners who assist in
              delivering our services (e.g., hosting providers, CRM tools,
              analytics platforms)
            </li>
            <li>
              With advertising platforms for campaign execution and performance
              measurement
            </li>
            <li>
          ...
          <p className="mt-3 text-[14px] sm:text-[16px] leading-relaxed text-[#374151]">
            All third parties are required to maintain the confidentiality and
