...
export default function SubServicePage({ vikeSlug }) {
  // ✅ Step 1: Try to get slug from Vike routeParams (when accessed via /services/:slug directly)
  let slugFromVike = vikeSlug;
  try {
    const pageContext = usePageContext();
    slugFromVike = vikeSlug || pageContext?.routeParams?.slug;
  } catch {
    // not in Vike context
  }
  ...
  return (
    <div>
        ...
        >
          ...
          >
            <div className="max-w-[721px] sm:h-[361px] sm:mt-2">
              ...
              <div className="mt-6 flex flex-col items-center gap-3 sm:mt-8 sm:flex-row sm:flex-wrap sm:items-center sm:gap-4">
                <button
                  type="button"
      ...
      <motion.section
        ...
        viewport={{ once: true, amount: 0.2 }}
        variants={fadeUp}
        className="mx-auto m-[60px] sm:m-[70px] text-center font-poppins px-3 sm:max-w-[850px]"
      >
